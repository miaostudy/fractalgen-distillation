...
if __name__ == "__main__":
    ...
    parser.add_argument('--class_names_path', default='misc/class_woof.txt', type=str, help="类名列表文件")
    parser.add_argument('--class_indices_path', default='misc/class_woof_indices.txt', type=str, help="类索引文件")
